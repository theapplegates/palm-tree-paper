...
<Picture
  src="assets/images/TheMet_New_York_City"
  alt="Demo image served from Cloudinary in JXL, AVIF, and WebP."
  width={2000}
  height={1500}
  sizes="(min-width: 768px) 720px, 100vw"
  breakpoints={breakpoints["assets/images/TheMet_New_York_City"]}
  pictureClass="responsive-picture"
/>

Photo by <a href="https://unsplash.com/@metropolitanmuseum?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">The Metropolitan Museum of Art</a> on <a href="https://unsplash.com/photos/Nr40IIL3e3I?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
